...
Function Get-TargetResource
{
    ...
    $netAdapter = Get-VMNetworkAdapter @arguments -IsLegacy $false -ErrorAction SilentlyContinue
...
Function Set-TargetResource
{
    ...
    Write-Verbose -Message $localizedData.GetVMNetAdapter
    $netAdapterExists = Get-VMNetworkAdapter @arguments -IsLegacy $false -ErrorAction SilentlyContinue
        ...
        if ( $netAdapterExists )
        {
            ...
            if ( $VMName -ne 'ManagementOS' )
            {
                ...
                if ( $updateMacAddress )
                {
                    ...
                    Set-VMNetworkAdapter @setArguments -ErrorAction Stop -Verbose
                }
            }
        }
        else
    ...
    {
        Remove-VMNetworkAdapter @arguments -ErrorAction Stop -Verbose
    }
}
